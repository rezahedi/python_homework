...
def test_pig_latin():
    ...
    assert a1.pig_latin("hello world") == "ellohay orldway"
    assert a1.pig_latin("trfhg") == "trfhgay"
    assert a1.pig_latin("trfhog") == "ogtrfhay"
    assert a1.pig_latin("hqufg") == "hqufgay"
    assert a1.pig_latin("trfhquofg") == "ofgtrfhquay"
    assert a1.pig_latin("trfhuofg") == "uofgtrfhay"
    assert a1.pig_latin("string with consonants") == "ingstray ithway onsonantscay"
    assert a1.pig_latin("square queen") == "aresquay eenquay"
    assert a1.pig_latin("book keep push submit pig latin") == "ookbay eepkay ushpay ubmitsay igpay atinlay"